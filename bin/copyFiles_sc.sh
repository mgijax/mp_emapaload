...
echo 'copying bhmgiapp01:/data/loads/mgi/vocload/runTimeMP/mp.owl to /data/loads/sc/mgi/vocload/runTimeMP'
cd /data/loads/sc/mgi/vocload/runTimeMP
scp bhmgiapp01:/data/loads/mgi/vocload/runTimeMP/mp.owl .

echo 'copying  bhmgiapp01:/data/loads/mgi/vocload/emap/input/EMAPA.obo /data/loads/sc/mgi/vocload/emap/input'
cd /data/loads/sc/mgi/vocload/emap/input/
